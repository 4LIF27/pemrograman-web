...
$idbr = $_GET["id"];
$getdata = mysqli_query(conn(), "SELECT * FROM berita WHERE id_berita = '$idbr'");
...
<head>
  ...
  <title>BeritaKini - Admin Update Berita</title>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Update Berita</h6>
                    </div>
                    <div class="card-body container"> 
                        <?php 
                          $ftc = mysqli_fetch_assoc($getdata);
                          if (isset($_POST["submit"])) {
                            ...
                            if ($throw != null) {
                              ...
                              $syntax = "UPDATE `berita` SET judul='$judul', penulis='$penulis', berita='$content' $addimg WHERE id_berita = '648db38f79bd5'";
                              if (mysqli_query(conn(), $syntax)) {
                                ?>
                                <div class="alert alert-success mb-3">
                                  <strong>SUCCESS!</strong> Berhasil update berita
                                </div>
                                <?php
                              } else {
                                ?>
                                <div class="alert alert-warning mb-3">
                                  <strong>WAIT!</strong> Gagal update berita
                                </div>
                                <?php
                              }
                            }
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" name="judul" value="<?= $ftc["judul"] ?>" id="judul" placeholder="judul berita" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="penulis" value="<?= $ftc["penulis"] ?>" name="penulis" placeholder="nama penulis" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="select2-single-placeholder form-control h-100" name="kategori" id="ktg" required>
                                          <option value="<?= $ftc["id_kategori"] ?>">Default</option>
                                          <?php
                            ...
                            <div class="form-group">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="content" name="content" rows="8" required><?= $ftc["berita"] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
